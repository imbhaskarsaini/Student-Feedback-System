    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar" style="background-color:#164E12">
       ...
       <li><a href="feedback_average.php">Feedback Average</a></li>
