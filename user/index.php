...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background:#164E12">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar" style="background:#164E12">
          <ul class="nav nav-sidebar">
            <li  style="background:#164E12"><a href="index.php">Student <span class="sr-only">(current)</span></a></li>
			<!-- find users' image if image not found then show dummy image -->




			<li><a href="index.php?page=update_password"><span class="glyphicon glyphicon-book"></span> Update Password</a></li>
...
<br><br><br><br>
      ...
      <div class="container">
      <h1><b>Online Student Feedback System</b> </h1>
    <b>  <p class="jumbotron">
    ...
    To ensure we continue to meet these commitments, we need to know how well we are doing and what you’d like to see done better.
     ...
     <i>Student feedback</i> is an important part of this process. Your feedback also provides us with ideas and incentives to make further improvements in what we do for you.</p></b>
    </div>
